...
public class GetMeetingReportQueryHandler : IRequestHandler<GetMeetingReportQuery, Result<List<MeetingReportDto>>>
{
    private readonly IApplicationDbContext _context;

    public GetMeetingReportQueryHandler(IApplicationDbContext context)
    {
        _context = context;
    }

    public async Task<Result<List<MeetingReportDto>>> Handle(GetMeetingReportQuery request, CancellationToken cancellationToken)
    {
        ...
        return Result<List<MeetingReportDto>>.Success(meetings);
    }
}
